$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', name: 'writerId', index: 'writerId', width: 50, key: true, hidden: true},
            {label: '笔名', name: 'writerName', index: 'writerName', width: 140},
            {label: '真名', name: 'newsCoverImage', index: 'newsCoverImage', width: 120, formatter: coverImageFormatter},
            {label: '手机号', name: 'newsViews', index: 'newsViews', width: 60},
        ...
        jsonReader: {
            root: "data.data",
            page: "data.indexpage",
            total: "data.countpage",
            records: "data.countrows"
        },
        prmNames: {
            page: "page",
            rows: "limit",
